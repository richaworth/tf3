...
def main():
    ...
    for set in ["lower"]:
        ...
        model = YOLO(Path(f"C:/data/tf3/yolo_models/yolo_tooth_finder_{set}_jaw.pt"), task="detect", verbose=True)
        # model = YOLO(Path("C:/data/tf3/yolo_teeth_finder/lower/train3/weights/epoch40.pt"), task="detect", verbose=True)
